...
export function ToolsView() {
  ...
  const tools = useMemo<Tool[]>(() => [
    ...
    },
    {
      ...
      name: "Database",
      command: "npx",
      getArgs: () => ["-y", "@modelcontextprotocol/server-database"],
      getEnv: () => ({}),
      icon: (
        <svg
          width="24"
    ...
    },
    {
      ...
      command: "npx",
      getArgs: () => ["-y", "@modelcontextprotocol/server-code"],
      getEnv: () => ({}),
      icon: (
        <svg
          width="24"
    ...
    },
    {
      ...
      name: "Scheduler",
      command: "npx",
      getArgs: () => ["-y", "@modelcontextprotocol/server-scheduler"],
      getEnv: () => ({}),
      icon: (
        <svg
          width="24"
  ...
  ], [exaApiKey]); // Add exaApiKey as a dependency
